...
INFO|CENTRIS-OAUTH|hop 2 302 → location: https://centris-prod.ca.auth0.com/login/callback?code=pXlUZEGtvD789SX9k9khrB0Ujopbd-XSs8uv9bqMQAQ&state=svqRR-GzEDAs01Jg
INFO|CENTRIS-OAUTH|hop 3 → https://centris-prod.ca.auth0.com/login/callback?code=pXlUZEGtvD789SX9k9khrB0Ujopbd-XSs8uv9bqMQAQ&state=svqRR-GzEDAs01Jg
INFO|CENTRIS-OAUTH|hop 3 302 → location: /authorize/resume?state=_WmjSIp11d1ui1Y2eaPluiGOUOACoIZ1
INFO|CENTRIS-OAUTH|hop 4 → https://centris-prod.ca.auth0.com/authorize/resume?state=_WmjSIp11d1ui1Y2eaPluiGOUOACoIZ1
INFO|CENTRIS-OAUTH|hop 4 302 → location: /u/mfa-sms-challenge?state=hKFo2SBVV3FXTTVjTFlHOVpJdDU5Vm1KeTJJZUlpSDFOa1hENKFusG1mYS1hdXRoZW50aWNhdGWjdGlk2SBfV21qU0lwM
INFO|CENTRIS-OAUTH|hop 5 → https://centris-prod.ca.auth0.com/u/mfa-sms-challenge?state=hKFo2SBVV3FXTTVjTFlHOVpJdDU5Vm1KeTJJZUlpSDFOa1hENKFusG1mYS1h
WARN|CENTRIS-OAUTH|hop 5 STUCK at https://centris-prod.ca.auth0.com/u/mfa-sms-challenge?state=hKFo2SBVV3FXTTVjTFlH — HTML: <!DOCTYPE html> <html lang="fr-CA"> <head> <meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <meta name="viewport" content="width=device-width, initial-scale=1"> <meta name=
WARN|CENTRIS|OAuth flow échoué: Pas de form_post matrix après auth — fallback form-based
OK|VEILLE|Notif backup #35 envoyée
...
OK|GIST|Poller state restauré: 389 processed, 120 leads
...
INFO|VEILLE|Backup check campagnes suspended pour demain...
INFO|VEILLE|veille_35_2026-05-19 déjà fait (Mac scheduler probablement)
```

## Environnement
- Node: v22.22.0
- Platform: linux
- Memory: {"rss":123047936,"heapTotal":31285248,"heapUsed":27941376,"external":6857610,"arrayBuffers":3219565}
