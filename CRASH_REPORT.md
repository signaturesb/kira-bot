# 🚨 uncaughtException
_2026-05-20 05 h 25 min 54 s_

## Erreur
```
m is not defined
ReferenceError: m is not defined
    at Timeout._onTimeout (/opt/render/project/src/bot.js:11744:20)
...
OK|DROPBOX|Structure: 83 listings (Terrain en ligne: 50, Inscription: 33), 5 sections
...
OK|BOOT|✅ Kira démarrée [claude-sonnet-4-6] — /tmp — mémos:195 — tools:62 — port:10000
...
INFO|CENTRIS-OAUTH|hop 2 302 → location: https://centris-prod.ca.auth0.com/login/callback?code=s1qpCPkD_YSQ7QpFe94QjQE5xtAeFIkjiK00tOc2Erw&state=kPAFoH-OOk--u6d2
INFO|CENTRIS-OAUTH|hop 3 → https://centris-prod.ca.auth0.com/login/callback?code=s1qpCPkD_YSQ7QpFe94QjQE5xtAeFIkjiK00tOc2Erw&state=kPAFoH-OOk--u6d2
OK|PREFLIGHT|✅ Claude API accepte les 62 tools
OK|WEBHOOK|Sync OK (boot) — secret=set
INFO|AUDIT|webhook/synced {"reason":"boot","hasSecret":true}
INFO|CENTRIS-OAUTH|hop 3 302 → location: /authorize/resume?state=1HOoSLqm-rqga6zVR5aKoPAqgSMbR02g
INFO|CENTRIS-OAUTH|hop 4 → https://centris-prod.ca.auth0.com/authorize/resume?state=1HOoSLqm-rqga6zVR5aKoPAqgSMbR02g
INFO|CENTRIS-OAUTH|hop 4 302 → location: /u/mfa-sms-challenge?state=hKFo2SB1VDJXZzZRakJQQVU2S2M0N1ozME80UWF5UzdXZVk1RaFusG1mYS1hdXRoZW50aWNhdGWjdGlk2SAxSE9vU0xxb
INFO|CENTRIS-OAUTH|hop 5 → https://centris-prod.ca.auth0.com/u/mfa-sms-challenge?state=hKFo2SB1VDJXZzZRakJQQVU2S2M0N1ozME80UWF5UzdXZVk1RaFusG1mYS1h
WARN|CENTRIS-OAUTH|hop 5 STUCK at https://centris-prod.ca.auth0.com/u/mfa-sms-challenge?state=hKFo2SB1VDJXZzZRakJQ — HTML: <!DOCTYPE html> <html lang="fr-CA"> <head> <meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <meta name="viewport" content="width=device-width, initial-scale=1"> <meta name=
...
OK|GIST|Poller state restauré: 405 processed, 124 leads
...
- Node: v22.22.0
- Platform: linux
- Memory: {"rss":121364480,"heapTotal":30429184,"heapUsed":24741368,"external":4686294,"arrayBuffers":1043227}
- Env vars présents: 145
