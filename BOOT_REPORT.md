...
INFO|CENTRIS-OAUTH|hop 2 302 → location: https://centris-prod.ca.auth0.com/login/callback?code=k2PmqxnMSEiInbVceHBtzl_L7Se703GBaR1SrYc5wJY&state=R-s5KAF78Htungp5
INFO|CENTRIS-OAUTH|hop 3 → https://centris-prod.ca.auth0.com/login/callback?code=k2PmqxnMSEiInbVceHBtzl_L7Se703GBaR1SrYc5wJY&state=R-s5KAF78Htungp5
INFO|CENTRIS-OAUTH|hop 3 302 → location: /authorize/resume?state=2yiZRiCPUldVsGvM7x7dBhmffZRkK_Uq
INFO|CENTRIS-OAUTH|hop 4 → https://centris-prod.ca.auth0.com/authorize/resume?state=2yiZRiCPUldVsGvM7x7dBhmffZRkK_Uq
INFO|CENTRIS-OAUTH|hop 4 302 → location: /u/mfa-sms-challenge?state=hKFo2SBXTGhaWWFSOXBKVDMxZk5xUmlYNlZQS3Bfc192Mzc5MKFusG1mYS1hdXRoZW50aWNhdGWjdGlk2SAyeWlaUmlDU
INFO|CENTRIS-OAUTH|hop 5 → https://centris-prod.ca.auth0.com/u/mfa-sms-challenge?state=hKFo2SBXTGhaWWFSOXBKVDMxZk5xUmlYNlZQS3Bfc192Mzc5MKFusG1mYS1h
WARN|CENTRIS-OAUTH|hop 5 STUCK at https://centris-prod.ca.auth0.com/u/mfa-sms-challenge?state=hKFo2SBXTGhaWWFSOXBK — HTML: <!DOCTYPE html> <html lang="fr-CA"> <head> <meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <meta name="viewport" content="width=device-width, initial-scale=1"> <meta name=
...
OK|GIST|Poller state restauré: 402 processed, 124 leads
...
INFO|POLLER|Junk: Propriété Centris #18366287 - 280 Rg Montcalm, Saint-Esprit (Shawn Barrette <centris@mlsmatrix.com>)
INFO|POLLER|Junk: Propriété Centris #18366287 - 280 Rg Montcalm, Saint-Esprit (Shawn Barrette <centris@mlsmatrix.com>)
OK|BOOT|✅ Pre-flight: 8/9 OK
INFO|AUDIT|boot/preflight_issues {"failed":[{"label":"Telegram API","detail":"fetch failed"}]}
```
